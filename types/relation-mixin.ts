...
import {PersistedModelClass, AnyObject} from '..';
...
export interface RelationMixin {
   ...
   */
  hasMany(modelTo: PersistedModelClass, params: AnyObject): RelationDefinition;
   ...
   */
  hasOne(modelTo: PersistedModelClass, params: AnyObject): RelationDefinition;
