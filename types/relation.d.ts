...
import {Where, Filter} from './query';
 ...
 * Relation definition
 */
export declare class RelationDefinition implements AnyObject {
  name: string;
  type: RelationType;
  modelFrom: PersistedModelClass;
  keyFrom: string;
  modelTo: PersistedModelClass;
  keyTo: string;
  polymorphic: AnyObject | boolean;
  modelThrough?: PersistedModelClass;
  keyThrough?: string;
  multiple: boolean;
